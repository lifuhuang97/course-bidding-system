...
<body>
    ...
    <div class="container">
        ...
        <div class="display-right">
            <div class="display-right__bidSystem">
                <?php
                ...
                <div class="form-container">
                    ...
                    <form action="processAdminCommands.php?token=<?php echo "{$_GET['token']};"?>" method="post">
                        <div class="form-group">
                            ...
                            <span style="margin-top: 10px">Status: <?= $roundStatus ?></span>
                        </div>
                        <div class="form-group" style="float: right; margin-top: 0.5em">
                            <?php
// disables buttons according to round status
                            ...
                            echo "<input class='form-btn' type='submit' name='submit' value='Start Round'$startStatus?>";
                            echo "<input class='form-btn' type='submit' name='submit' value='Clear Round' $clearStatus>";
                            echo "<input class='form-btn' type='submit' name='submit' value='Reset Round'>";
                            ?>
                        </div>
                    </form>
                </div>
            </div>
            <div class="display-right__bidInfo">
                <?php
...
// $allSuccessfulBids = $successBidDAO->getAllSuccessfulBids();
            ...
            <br>
            <br>
            <div class="display-right__allInfo">
